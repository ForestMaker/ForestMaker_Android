...
import com.example.forestmaker.server.repository.HomeRepository
...
class HomeViewModel : ViewModel() {
    ...
    var homeRes = MutableLiveData<MainResponse>()

    fun getHome(id: JsonObject) {
        disposables.add(homeRepository.getHome(id)
